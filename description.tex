...
\begin{description}
\item[Operators and special functions] are \op{purple}.
...
\item[Free variables and free functions] are \fv{green}. This includes quantities such as $\fv{x}$ and $\fv{n}$ in the binomial approximation $(\fc{1}\op{+}\fv{x})^{\fv{n}} \approx \fc{1} \op{+} \fv{n}\fv{x}$
