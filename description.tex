...
For example, let 
bound functions (e.g. $\sin$) and operators be \textcolor{Brown}{brown},
independent free variables and functions be red,
dependent free variables be dark red,
bound variables and indices be gray,
and constants be blue.
